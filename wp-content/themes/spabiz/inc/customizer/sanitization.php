 ...
 */
function spabiz_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function spabiz_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function spabiz_sanitize_html( $html ) {
 ...
 */
function spabiz_sanitize_image( $image, $setting ) {
 ...
 */
function spabiz_sanitize_nohtml( $nohtml ) {
 ...
 */
function spabiz_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function spabiz_sanitize_range_value( $number, $setting ) {
 ...
 */
function spabiz_sanitize_select( $input, $setting ) {
 ...
 */
function spabiz_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function spabiz_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function spabiz_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
