	...
	<div class="dt__header-inner">
		...
		<div class="dt__header-navwrapper">
			<div class="dt__header-navwrapperinner">
					...
					<div class="dt-container">
						<div class="dt-row">
							...
							<div class="dt-col-10 dt-my-auto">
								<?php do_action('cosmobit_site_header_contact_details'); ?>
							</div>
						</div>
					</div>
				</div>
				<div class="dt__navbar dt-d-none dt-d-lg-block">
					<div class="dt__navbar-wrapper <?php if($cosmobit_hs_hdr_sticky=='1'): echo esc_attr_e('is--sticky','celexo'); endif; ?>">
						<div class="dt-container">
							<div class="dt-row">
				...
				<div class="dt__mobilenav <?php if($cosmobit_hs_hdr_sticky=='1'): echo esc_attr_e('is--sticky','celexo'); endif; ?> dt-d-lg-none">
