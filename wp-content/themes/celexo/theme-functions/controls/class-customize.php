	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Cosmobit_Customize_Section_Pro(
				...
				'cosmobit',
				array(
                    'pro_text' => esc_html__( 'Upgrade to Celexo Pro','celexo' ),
                    'pro_url'  => 'https://desertthemes.com/themes/celexo-pro/',
                    'priority' => 0
                )
			)
		);
